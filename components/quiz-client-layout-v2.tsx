...
import { SearchNewsCardFixed } from "@/components/search-news-card-fixed";
...
export function QuizClientLayoutV2({
  mode = "all",
  type = "all",
  difficulty = "all",
  category = "all"
        ...
        <>
          ...
          <section className="glass-card rounded-[32px] p-5">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <SearchNewsCardFixed
                provider="google"
                keyword={currentQuestion.answer}
                url={`https://www.google.com/search?q=${searchKeyword}`}
              />
              <SearchNewsCardFixed
                provider="naver"
                keyword={currentQuestion.answer}
                url={`https://search.naver.com/search.naver?query=${searchKeyword}`}
              />
            </div>
          </section>
